...
export function CreateEventForm({ organizations, showAiContextDisclosure }: CreateEventFormProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Step indicator */}
      <div
        className="flex flex-col gap-3 rounded-2xl border border-border/60 bg-background/80 p-4 sm:flex-row sm:items-center sm:gap-4 sm:p-5"
        data-motion="settle"
      >
        <StepIndicator
          number={1}
      ...
      <div key={step} data-motion="settle">
        {/* Organization step */}
        {step === 'organization' && (
          <Surface className="space-y-6" data-motion-item>
        ...
        {/* Event step */}
        {step === 'event' && (
          <Form form={form} className="space-y-6" data-motion-item>
...
function StepIndicator({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'motion-status flex h-10 w-10 items-center justify-center rounded-full border text-sm font-semibold',
