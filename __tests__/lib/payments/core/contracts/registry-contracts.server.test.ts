...
const canonicalEventFixtureByName = {
  ...
  'payout.queued': {
    eventId: '93939393-9393-4939-8939-939393939393',
    traceId: 'trace-payout-queue-1',
    occurredAt: '2026-02-23T11:00:00.000Z',
    recordedAt: '2026-02-23T11:00:00.000Z',
    eventName: 'payout.queued',
    version: 1,
    entityType: 'payout',
    entityId: 'queued-intent-1',
    source: 'api',
    idempotencyKey: 'idem-payout-queue-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutQueuedIntentId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
  ...
  'payout.processing': {
    ...
    traceId: 'trace-payout-processing-1',
    ...
    entityId: 'payout-1',
    source: 'worker',
    idempotencyKey: 'idem-payout-processing-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
      payoutQuoteId: '12345678-1234-4234-8234-123456789012',
      currentRequestedAmount: { amountMinor: 12000, currency: 'MXN' },
    },
  },
  'payout.paused': {
    eventId: '10000000-0000-4000-8000-000000000002',
    traceId: 'trace-payout-paused-1',
    ...
    entityId: 'payout-1',
    source: 'worker',
    idempotencyKey: 'idem-payout-paused-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
  ...
  'payout.resumed': {
    ...
    traceId: 'trace-payout-resumed-1',
    occurredAt: '2026-02-23T14:00:00.000Z',
    recordedAt: '2026-02-23T14:00:00.000Z',
    eventName: 'payout.resumed',
    version: 1,
    entityType: 'payout',
    entityId: 'payout-1',
    source: 'worker',
    idempotencyKey: 'idem-payout-resumed-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
      payoutQuoteId: '12345678-1234-4234-8234-123456789012',
      currentRequestedAmount: { amountMinor: 10000, currency: 'MXN' },
      reasonCode: 'risk_conditions_resolved',
    },
  },
  'payout.completed': {
    eventId: '10000000-0000-4000-8000-000000000004',
    traceId: 'trace-payout-completed-1',
    occurredAt: '2026-02-23T15:00:00.000Z',
    recordedAt: '2026-02-23T15:00:00.000Z',
    ...
    entityId: 'payout-1',
    source: 'worker',
    idempotencyKey: 'idem-payout-completed-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
      payoutQuoteId: '12345678-1234-4234-8234-123456789012',
      settledAmount: { amountMinor: 10000, currency: 'MXN' },
    },
  },
  'payout.failed': {
    eventId: '10000000-0000-4000-8000-000000000005',
    traceId: 'trace-payout-failed-1',
    occurredAt: '2026-02-23T15:30:00.000Z',
    recordedAt: '2026-02-23T15:30:00.000Z',
    eventName: 'payout.failed',
    version: 1,
    entityType: 'payout',
    entityId: 'payout-2',
    source: 'worker',
    idempotencyKey: 'idem-payout-failed-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-fffffffffffe',
      payoutQuoteId: '12345678-1234-4234-8234-123456789013',
      failedAmount: { amountMinor: 7000, currency: 'MXN' },
  ...
  'payout.adjusted': {
    ...
    occurredAt: '2026-02-23T13:05:00.000Z',
    recordedAt: '2026-02-23T13:05:00.000Z',
    eventName: 'payout.adjusted',
    version: 1,
    entityType: 'payout',
    entityId: 'payout-1',
    source: 'worker',
    idempotencyKey: 'idem-payout-adjusted-1',
    metadata: { sourceSystem: 'tests' },
    payload: {
      organizerId: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
      payoutRequestId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
