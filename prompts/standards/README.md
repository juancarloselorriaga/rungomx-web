...
- `engineering-principles.md` — maintainability review guidance for naming clarity, focused units, duplicated domain logic, explicit side effects, and abstraction discipline
