...
CREATE TABLE "event_distances" (
	...
	"capacity" integer,
	"capacity_scope" varchar(20) DEFAULT 'per_distance' NOT NULL,
...
ALTER TABLE "event_faq_items" ADD CONSTRAINT "event_faq_items_edition_id_event_editions_id_fk" FOREIGN KEY ("edition_id") REFERENCES "public"."event_editions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
